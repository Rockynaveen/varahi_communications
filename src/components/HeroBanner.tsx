...
export const HeroBanner: React.FC<HeroBannerProps> = ({ onNavigateApply }) => {
  return (
    <section className="relative w-full min-h-[640px] lg:min-h-[720px] flex items-center bg-[#0f172a] overflow-hidden text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        <div className="max-w-2xl space-y-6">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
            <h1 
              style={{ color: '#ffffff' }} 
              className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.15] font-['Barlow'] drop-shadow-md gold-shimmer"
            >
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '400ms', animationFillMode: 'both' }}>
            <h2 
              style={{ color: '#ffffff' }} 
              className="text-xl sm:text-2xl font-medium text-white font-['Jost'] drop-shadow-xs leading-relaxed"
            >
          ...
          <div className="animate-fade-in-up pt-2" style={{ animationDelay: '600ms', animationFillMode: 'both' }}>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6">
              ...
              <button
                ...
                style={{ color: '#123328' }}
                className="inline-flex items-center justify-center gap-3 bg-[#c5a059] hover:bg-white text-[#123328] border border-[#c5a059] px-8 py-4 rounded-xl font-bold uppercase tracking-wider text-sm transition-all duration-300 transform hover:-translate-y-1 shadow-xl cursor-pointer group btn-glow animate-pulse-glow"
              >
              ...
              <div className="flex items-center gap-4 bg-[#123328]/80 border border-[#c5a059]/50 backdrop-blur-md px-5 py-3 rounded-xl shadow-lg animate-border-glow">
                <div className="w-12 h-12 rounded-full bg-[#c5a059] flex items-center justify-center text-[#123328] shrink-0 shadow-md">
                  <PhoneCall className="w-6 h-6 text-[#123328] animate-bounce" />
                </div>
                <div>
                  <p style={{ color: '#ffffff' }} className="text-xs text-white font-semibold">Check Eligibility Today</p>
                  <a
                    href="tel:18004567890"
                    className="text-lg font-bold text-[#c5a059] hover:text-white transition-colors tracking-wide"
                  >
                    1800-456-7890
                  </a>
                </div>
